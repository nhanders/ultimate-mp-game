...
class Entity {
   ...
   */
  inWorld() {
    return Util.inBound(this.position.x, Constants.FIELD_MIN_X, Constants.FIELD_MAX_X) &&
      Util.inBound(this.position.y, Constants.FIELD_MIN_Y, Constants.FIELD_MAX_Y)
  }
